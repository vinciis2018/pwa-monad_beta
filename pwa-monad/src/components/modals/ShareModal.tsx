...
export function ShareModal({ isOpen, onClose, nftId, nftTitle }: Props) {
  ...
  const { hasCopied: hasPermainkCopied, onCopy: onPermalinkCopy } =
    useClipboard(permalink);
  const { hasCopied: hasEmbedLinkCopied, onCopy: onEmbedLinkCopy } =
    useClipboard(embedLink);
                ...
                <InputGroup>
                  ...
                  <Box pos="relative">
                    <InputRightAddon
                      ...
                      textAlign="center"
                      children={
                        hasPermainkCopied ? "Copied" : "Copy share link"
                      }
                ...
                <InputGroup>
                  ...
                  <Box pos="relative">
                    <InputRightAddon
                      ...
                      cursor="pointer"
                      children={
                        hasEmbedLinkCopied ? "Copied" : "Copy embed link"
                      }
